...
### Model with simplified training procedure ###
# # Neural network
# 
...
def _build_model(n_input: int, n_output: int, learning_rate: float=1e-4,
    ...
    models["chi"] = NNModel(
        ...
        verbose=0,
        epochs=KoopmanModel.n_epoch_chi)
    ...
    models["all"] = NNModel(
        ...
        epochs=KoopmanModel.n_epoch_aux, verbose=0)
    models["both"] = NNModel(
...
class KoopmanModel:
    ...
    def train_model(self):
        ...
        self._log("Chi valid loss: {0}".format(self._models["chi"]._history[0].history["val_loss"][-1]))
